...
import { ManifestService } from './PartialManifestBooking.service';
...
@Component({
  selector: 'app-partial-manifest-booking',
  standalone:true,
	imports: [
		NgFor,
		DecimalPipe,
  ...
  templateUrl: './partial-manifest-booking.component.html',
  styleUrls: ['./partial-manifest-booking.component.css'],
  providers: [ManifestService, DecimalPipe],
})
export class PartialManifestBookingComponent {
  ...
  Bookings$: Observable<ManifestBookingList[]>;
	...
	constructor(public service: ManifestService, private modalservices:NgbModal) {
...
this.modalservices.open(modal,{ size: 'xl' })
	...
	Complete_Booking(modal:any,LR_Number:number)
	{
		this.modalservices.open(modal,{ size: 'xl' })

...
function matches(IncomingVehicleList: VehicleInterface, term: string, pipe: PipeTransform) {
	...
	return (
		IncomingVehicleList.Vehicle.toLowerCase().includes(term.toLowerCase()) ||
		IncomingVehicleList.Vehicle_Type.toLowerCase().includes(term.toLowerCase()) ||
		IncomingVehicleList.Origin_Facility.toLowerCase().includes(term.toLowerCase()) ||
		IncomingVehicleList.ETA.toLowerCase().includes(term.toLowerCase()) ||
		
		IncomingVehicleList.Last_Location.toLowerCase().includes(term.toLowerCase()) ||

		
        pipe.transform(IncomingVehicleList.Consignment_Count).includes(term)
	);
